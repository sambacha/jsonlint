...
var extended = (function () {
  var o = function (k, v, o, l) { for (o = o || {}, l = k.length; l--; o[k[l]] = v);return o }; var $V0 = [1, 12]; var $V1 = [1, 13]; var $V2 = [1, 14]; var $V3 = [1, 9]; var $V4 = [1, 10]; var $V5 = [1, 11]; var $V6 = [1, 15]; var $V7 = [1, 16]; var $V8 = [15, 19, 23, 25]; var $V9 = [15, 19, 22, 23, 25]; var $Va = [19, 23]; var $Vb = [23, 25]
  var parser = { trace: function trace () { },
    yy: {},
    symbols_: { 'error': 2, 'JSONString': 3, 'STRING': 4, 'SINGLEQUOTE_STRING': 5, 'JSONNumber': 6, 'NUMBER': 7, 'JSONNullLiteral': 8, 'NULL': 9, 'JSONBooleanLiteral': 10, 'TRUE': 11, 'FALSE': 12, 'JSONText': 13, 'JSONValue': 14, 'EOF': 15, 'JSONObject': 16, 'JSONArray': 17, '{': 18, '}': 19, 'JSONMemberList': 20, 'JSONMember': 21, ':': 22, ',': 23, '[': 24, ']': 25, 'JSONElementList': 26, '$accept': 0, '$end': 1 },
    terminals_: { 2: 'error', 4: 'STRING', 5: 'SINGLEQUOTE_STRING', 7: 'NUMBER', 9: 'NULL', 11: 'TRUE', 12: 'FALSE', 15: 'EOF', 18: '{', 19: '}', 22: ':', 23: ',', 24: '[', 25: ']' },
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = extended
  exports.Parser = extended.Parser
  exports.parse = function () { return extended.parse.apply(extended, arguments) }
